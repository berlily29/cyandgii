                        ...
                        <div class="card shadow mb-3">
                            ...
                            <div class="card-body">
                                <form>
                                    <div class="row">
                                        <div class="col">
                                            <div class="mb-3"><label class="form-label" for="Title" style="color: var(--bs-emphasis-color);"><strong>In Charge</strong></label><input class="form-control" type="text" id="username-2" name="Title" style="width: 528px;height: 38px;padding: 6px 12px;color: rgb(133,135,150);border-radius: 5.6px;display: block;"></div>
                                            <div class="mb-3" style="margin-top: 15px;"><label class="form-label" for="Lead" style="color: var(--bs-emphasis-color);"><strong>College, Branch Campus</strong></label><input class="form-control" type="text" id="username-1" name="Lead" style="width: 528px;height: 38px;padding: 6px 12px;color: rgb(133,135,150);border-radius: 5.6px;display: block;"></div>
                                            <div class="mb-3" style="margin-top: 15px;"><label class="form-label" for="Proj_location" style="color: var(--bs-emphasis-color);"><strong>Name of Entity</strong></label><input class="form-control" type="text" id="username-6" name="Proj_location" style="width: 528px;height: 38px;padding: 6px 12px;color: rgb(133,135,150);border-radius: 5.6px;display: block;"></div>
                                            ...
                                            <div class="mb-3" style="margin-top: 15px;"><label class="form-label" for="Proposal_Letter" style="color: var(--bs-emphasis-color);"><strong>Notarized MOA/MOU</strong></label><input class="form-control" type="file" style="width: 528px;height: 38px;padding: 6px 12px;padding-left: 5pxpx;" name="Proposal_Letter"></div>
                                        </div>
                                        <div class="col">
                                            <div class="mb-3"><label class="form-label" for="Admin_Involved" style="color: var(--bs-emphasis-color);"><strong>Type of Partner Institution</strong></label><input class="form-control" type="text" id="username-3" name="Admin_Involved" style="width: 528px;height: 38px;padding: 6px 12px;color: rgb(133,135,150);border-radius: 5.6px;display: block;"></div>
                                            <div class="mb-3" style="margin-top: 15px;"><label class="form-label" for="Students_Involved" style="color: var(--bs-emphasis-color);"><strong>Nature of Collaboration</strong></label><input class="form-control" type="text" id="username-7" name="Students_Involved" style="width: 528px;height: 38px;padding: 6px 12px;color: rgb(133,135,150);border-radius: 5.6px;display: block;"></div>
                                            <div class="mb-3" style="margin-top: 15px;"><label class="form-label" for="Team_Leader" style="color: var(--bs-emphasis-color);"><strong>Deliverable/Desired Output</strong></label><input class="form-control" type="text" id="username-9" name="Team_Leader" style="width: 528px;height: 38px;padding: 6px 12px;color: rgb(133,135,150);border-radius: 5.6px;display: block;"></div>
                                            <div class="mb-3" style="margin-top: 15px;"><label class="form-label" for="Leader_Email" style="color: var(--bs-emphasis-color);"><strong>Target Beneficiaries</strong></label><input class="form-control" type="text" id="username-4" name="Team_Leader" style="width: 528px;height: 38px;padding: 6px 12px;color: rgb(133,135,150);border-radius: 5.6px;display: block;"></div>
                                            <div class="mb-3" style="margin-top: 15px;"><label class="form-label" for="Leader_Email" style="color: var(--bs-emphasis-color);"><strong>Target Beneficiaries</strong></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-xxl-11" style="width: 100%;">
                                            <form>
                                                ...
                                                <div class="col"><a class="btn btn-primary" role="button" style="margin-right: 5px;margin-left: 1040px;margin-top: 10px;border-color: rgb(141,0,0);background: rgb(141,0,0);" href="ECLC_LIST_MOA.html">Back</a><button class="btn btn-primary" type="submit" style="margin-top: 10px;margin-left: 10px;background: rgb(141,0,0);border-color: rgb(141,0,0);">Submit</button></div>
                                            </form>
                                        </div>
                                    </div>
                                </form>
