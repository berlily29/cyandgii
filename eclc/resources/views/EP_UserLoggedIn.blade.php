...
<body id="page-top" style="border-bottom-style: none;">
    <div id="wrapper">
                            ...
                            <div class="card shadow border-start-primary py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-primary fw-bold text-xs mb-1"><a href="EP_CROS_LIST_Projects_Proposals.html"><span style="color: rgb(141,0,0);font-weight: bold;font-size: 13px;">Project proposaL</span></a></div>
                                        </div>
                                        <div class="col-auto"><a href="EP_CROS_LIST_Projects_Proposals.html"><i class="fas fa-list-ul fa-2x text-gray-300"></i></a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-start-success py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-success fw-bold text-xs mb-1"><a href="EP_CROS_LIST_Projects.html"><span style="color: rgb(141,0,0);font-size: 13px;">MANAGE PROJECT&nbsp;</span></a></div>
                                        </div>
                                        <div class="col-auto"><a href="EP_CROS_LIST_Projects.html"><i class="fas fa-file-invoice fa-2x text-gray-300"></i></a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-start-warning py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-warning fw-bold text-xs mb-1" style="color: rgb(141,0,0);--bs-warning: rgb(141,0,0);--bs-warning-rgb: 141,0,0;"><a href="EP_ECLC_LIST_MOA.html"><span style="font-size: 13px;color: rgb(141,0,0);">MANAGE (MOA/MOU)</span></a></div>
                                            <div class="text-dark fw-bold h5 mb-0"></div>
                                        </div>
                                        <div class="col-auto"><a href="EP_ECLC_LIST_MOA.html"><i class="fas fa-file fa-2x text-gray-300"></i></a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col">
                                    <div class="card shadow mb-4">
                                        <div class="card-header py-3" style="background: rgb(248, 249, 252);">
                                            <h6 class="text-primary fw-bold m-0" style="--bs-primary: #8d0000;--bs-primary-rgb: 141,0,0;">Todo List</h6>
                                        </div>
