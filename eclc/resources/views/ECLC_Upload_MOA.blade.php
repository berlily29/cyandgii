            ...
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-start text-light" id="accordionSidebar">
                    <li class="nav-item" style="margin-top: 20px;">
                        ...
                        <a class="nav-link active" href="{{ asset('ECLC_Upload_MOA.html') }}" style="padding-bottom: 5px;padding-left: 55px;padding-top: 5px;font-weight: bold;font-size: 18px;">
                                ...
                                <form>
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="mb-3" style="margin-top: 15px;"><label class="form-label" for="Leader_Email"><strong>With Project or Without Project</strong></label>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-xxl-11" style="width: 100%;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col"></div>
                                            <div class="col"></div>
                                            <div class="col"><button class="btn btn-primary" type="button" style="margin-top: 10px;margin-left: 220px;background: rgb(141,0,0);border-color: rgb(141,0,0);">Submit</button></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
