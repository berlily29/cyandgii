        ...
        <nav class="navbar align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0 navbar-dark" style="background: rgb(141,0,0);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-start text-light" id="accordionSidebar">
                    <li class="nav-item" style="margin-top: 20px;"><a class="nav-link active" href="{{ url('/dashboard')}}" style="font-family: Nunito, sans-serif;padding-top: 5px;padding-bottom: 5px;font-size: 25px;font-weight: bold;" data-bs-target="CROS_Dashboard.html"><i class="fas fa-link" style="padding-right: 5px;font-size: 20px;"></i>ECLC</a><a class="nav-link" href="{{ url('/view')}}" style="padding-bottom: 5px;padding-left: 55px;padding-top: 5px;font-weight: bold;font-size: 18px;"><span style="font-weight: normal !important;">Upload</span></a><a class="nav-link" href="{{ url('list') }}" style="padding-bottom: 5px;padding-left: 55px;padding-top: 5px;font-weight: bold;font-size: 18px;"><span style="font-weight: normal !important;">Manage</span></a></li>
